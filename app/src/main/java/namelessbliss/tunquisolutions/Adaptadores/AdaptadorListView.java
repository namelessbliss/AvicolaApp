...
public class AdaptadorListView extends BaseAdapter {
    ...
    public AdaptadorListView(Context context, int layout, List<Cliente> list) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        final Cliente currentFruit = (Cliente) getItem(position);
        holder.nombre.setText(currentFruit.getNombre());
